...
/* ============================================================
   FORCE DEFAULT UI ON LOAD (IMPORTANT FIX)
============================================================ */
...
/* ============================================================
   AI TEXT-TO-SPEECH (SPEAKING MODE)
============================================================ */
...
function sendMessage() {
    ...
    fetch(API_URL, {
        ...
        .then(data => {
            ...
            // TEXT → TYPEWRITER ANSWER (NO SPEAKING)
