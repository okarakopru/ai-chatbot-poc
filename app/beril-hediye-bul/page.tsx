...
const U = (keywords: string, seed?: number) =>
  seed !== undefined
    ? `https://loremflickr.com/600/800/${keywords}?lock=${(seed * 997 + 42) % 99991}`
    : `https://images.unsplash.com/photo-${keywords}?w=600&h=800&fit=crop&q=80`;
...
const ALL_PRODUCTS: Product[] = [
  // ── TRAVEL (20) ──
  {
    ...
    image: U("passport,leather,wallet,travel", 1),
  ...
  },
  {
    ...
    image: U("luggage,organizer,travel,packing", 2),
  ...
  },
  {
    ...
    image: U("travel,journal,notebook,diary", 3),
  ...
  },
  {
    ...
    image: U("powerbank,charger,portable,battery", 4),
  ...
  },
  {
    ...
    image: U("airplane,window,travel,seat", 5),
  ...
  },
  {
    ...
    image: U("suitcase,packing,cubes,travel", 6),
    category: "travel", occasions: ["birthday", "newyear", "surprise"],
  ...
  },
  {
    ...
    image: U("wallet,slim,card,rfid", 7),
    category: "travel", occasions: ["birthday", "newyear", "surprise"],
  ...
  },
  {
    ...
    image: U("travel,adapter,plug,universal", 8),
  ...
  },
  {
    ...
    image: U("world,map,travel,adventure", 9),
  ...
  },
  {
    ...
    image: U("beach,towel,ocean,travel", 10),
    category: "travel", occasions: ["birthday", "surprise", "newyear"],
  ...
  },
  {
    ...
    image: U("sleep,mask,travel,night", 11),
  ...
  },
  {
    ...
    image: U("luggage,tag,leather,suitcase", 12),
    category: "travel", occasions: ["birthday", "valentines", "anniversary", "surprise"],
  ...
  },
  {
    ...
    image: U("hammock,nature,relaxing,travel", 13),
    category: "travel", occasions: ["birthday", "anniversary", "surprise"],
  ...
  },
  {
    ...
    image: U("polaroid,camera,instant,photo", 14),
  ...
  },
  {
    ...
    image: U("cosmetic,bag,makeup,travel", 15),
    category: "travel", occasions: ["birthday", "anniversary", "surprise"],
  ...
  },
  {
    ...
    image: U("compression,socks,travel,comfort", 16),
  ...
  },
  {
    ...
    image: U("camera,bag,photography,equipment", 17),
    category: "travel", occasions: ["birthday", "anniversary", "newyear"],
  ...
  },
  {
    ...
    image: U("wifi,internet,device,travel", 18),
  ...
  },
  {
    ...
    image: U("hiking,boots,outdoor,trail", 19),
    category: "travel", occasions: ["birthday", "newyear", "surprise"],
  ...
  },
  {
    ...
    image: U("suitcase,luggage,airport,travel", 20),
    category: "travel", occasions: ["birthday", "anniversary", "newyear"],
  ...
  // ── BOOK (15) ──
  {
    ...
    gradient: "from-gray-700 via-gray-600 to-zinc-600",
    image: U("kindle,ereader,book,reading", 21),
  ...
  },
  {
    ...
    image: U("bookmark,book,leather,reading", 22),
  ...
  },
  {
    ...
    image: U("books,gift,reading,literature", 23),
  ...
  },
  {
    ...
    image: U("lamp,reading,light,cozy", 24),
  ...
  },
  {
    ...
    gradient: "from-violet-800 via-purple-700 to-violet-700",
    image: U("headphones,audiobook,podcast,listening", 25),
  ...
  },
  {
    ...
    image: U("book,subscription,box,monthly", 26),
  ...
  },
  {
    ...
    gradient: "from-amber-900 via-amber-800 to-orange-800",
    image: U("classic,books,vintage,literature", 27),
  ...
  },
  {
    ...
    price: "₺299 – ₺799", emoji: "👓",
    gradient: "from-sky-800 via-blue-700 to-sky-700",
    image: U("glasses,eyewear,reading,screen", 28),
    category: "book", occasions: ["birthday", "newyear", "surprise"],
  ...
  },
  {
    ...
    gradient: "from-stone-700 via-stone-600 to-zinc-600",
    image: U("book,stand,holder,reading,desk", 29),
    category: "book", occasions: ["birthday", "surprise", "newyear"],
  ...
  },
  {
    ...
    gradient: "from-pink-800 via-rose-700 to-pink-700",
    image: U("pillow,reading,cozy,bedroom", 30),
    category: "book", occasions: ["birthday", "surprise", "newyear"],
  ...
  },
  {
    ...
    gradient: "from-slate-700 via-slate-600 to-gray-600",
    image: U("bookshelf,library,organized,books", 31),
  ...
  },
  {
    ...
    image: U("secret,box,storage,decorative", 32),
    category: "book", occasions: ["birthday", "valentines", "anniversary"],
  ...
  },
  {
    ...
    image: U("notebook,pen,writing,stationery", 33),
    category: "book", occasions: ["birthday", "surprise", "newyear"],
  ...
  },
  {
    ...
    gradient: "from-fuchsia-800 via-pink-700 to-fuchsia-700",
    image: U("writing,creative,course,pen", 34),
  ...
  },
  {
    ...
    image: U("coffee,book,reading,cozy", 35),
  ...
  // ── MUSIC (15) ──
  {
    ...
    price: "₺1.999 – ₺4.999", emoji: "🎧",
    gradient: "from-violet-800 via-purple-700 to-violet-700",
    image: U("headphones,noise,cancelling,wireless", 36),
  ...
  },
  {
    ...
    image: U("bluetooth,speaker,portable,waterproof", 37),
  ...
  },
  {
    ...
    image: U("music,streaming,spotify,headphones", 38),
  ...
  },
  {
    ...
    gradient: "from-red-800 via-red-700 to-rose-700",
    image: U("vinyl,record,player,turntable", 39),
  ...
  },
  {
    ...
    image: U("earbuds,wireless,tws,music", 40),
  ...
  },
  {
    ...
    gradient: "from-pink-800 via-rose-700 to-pink-700",
    image: U("concert,live,music,stage", 41),
  ...
  },
  {
    ...
    gradient: "from-amber-800 via-amber-700 to-orange-700",
    image: U("ukulele,guitar,instrument,music", 42),
  ...
  },
  {
    ...
    gradient: "from-sky-800 via-blue-700 to-sky-700",
    image: U("alarm,clock,bluetooth,speaker", 43),
  ...
  },
  {
    ...
    gradient: "from-stone-700 via-stone-600 to-zinc-600",
    image: U("headphones,wired,studio,music", 44),
  ...
  },
  {
    ...
    gradient: "from-purple-800 via-violet-700 to-purple-700",
    image: U("piano,music,course,instrument", 45),
  ...
  },
  {
    ...
    price: "₺399 – ₺899", emoji: "💿",
    gradient: "from-gray-700 via-gray-600 to-zinc-600",
    image: U("vinyl,record,album,music", 46),
  ...
  },
  {
    ...
    price: "₺199 – ₺499", emoji: "🎯",
    gradient: "from-teal-800 via-teal-700 to-cyan-700",
    image: U("headphone,stand,desk,accessories", 47),
    category: "music", occasions: ["birthday", "surprise"],
  ...
  },
  {
    ...
    image: U("speaker,small,bluetooth,desk", 48),
    category: "music", occasions: ["birthday", "surprise", "newyear"],
  ...
  },
  {
    ...
    price: "₺399 – ₺799", emoji: "🎁",
    gradient: "from-rose-800 via-rose-700 to-pink-700",
    image: U("music,gift,basket,notes", 49),
  ...
  },
  {
    ...
    price: "₺799 – ₺1.999", emoji: "🔈",
    gradient: "from-blue-800 via-blue-700 to-indigo-700",
    image: U("speaker,wearable,neck,bluetooth", 50),
    category: "music", occasions: ["birthday", "newyear", "surprise"],
  ...
  // ── COSMETIC (15) ──
  {
    ...
    price: "₺1.499 – ₺3.999", emoji: "🌸",
    gradient: "from-pink-800 via-rose-700 to-pink-700",
    image: U("perfume,bottle,fragrance,luxury", 51),
  ...
  },
  {
    ...
    gradient: "from-fuchsia-800 via-pink-700 to-fuchsia-700",
    image: U("skincare,serum,cosmetics,beauty", 52),
  ...
  },
  {
    ...
    image: U("haircare,shampoo,beauty,salon", 53),
  ...
  },
  {
    ...
    image: U("sunscreen,spf,suncare,beach", 54),
  ...
  },
  {
    ...
    image: U("lipbalm,lip,care,cosmetic", 55),
  ...
  },
  {
    ...
    image: U("jade,roller,facial,massage,stone", 56),
    category: "cosmetic", occasions: ["birthday", "valentines", "anniversary", "surprise"],
  ...
  },
  {
    ...
    price: "₺499 – ₺1.299", emoji: "🖌️",
    gradient: "from-purple-800 via-violet-700 to-purple-700",
    image: U("makeup,brushes,cosmetic,artist", 57),
  ...
  },
  {
    ...
    gradient: "from-sky-800 via-blue-700 to-sky-700",
    image: U("eyecream,skincare,beauty,cream", 58),
  ...
  },
  {
    ...
    gradient: "from-emerald-800 via-teal-700 to-emerald-700",
    image: U("bodylotion,scrub,bath,skincare", 59),
  ...
  },
  {
    ...
    price: "₺199 – ₺599", emoji: "🤲",
    gradient: "from-amber-800 via-amber-700 to-orange-700",
    image: U("handcream,lotion,cosmetic,gift", 60),
  ...
  },
  {
    ...
    gradient: "from-orange-800 via-orange-700 to-amber-700",
    image: U("hairdryer,salon,beauty,hair", 61),
  ...
  },
  {
    ...
    gradient: "from-slate-700 via-slate-600 to-gray-600",
    image: U("mirror,led,makeup,vanity", 62),
    category: "cosmetic", occasions: ["birthday", "newyear", "anniversary"],
  ...
  },
  {
    ...
    price: "₺399 – ₺999", emoji: "💄",
    gradient: "from-red-800 via-rose-700 to-red-700",
    image: U("lipstick,makeup,cosmetic,collection", 63),
  ...
  },
  {
    ...
    price: "₺399 – ₺899", emoji: "🌿",
    gradient: "from-teal-800 via-teal-700 to-cyan-700",
    image: U("steamer,facial,spa,beauty", 64),
    category: "cosmetic", occasions: ["birthday", "surprise", "newyear"],
  ...
  },
  {
    ...
    image: U("serum,vitamin,skincare,beauty,bottle", 65),
  ...
  // ── SPORT (15) ──
  {
    ...
    image: U("yoga,mat,exercise,fitness", 66),
  ...
  },
  {
    ...
    price: "₺2.499 – ₺5.999", emoji: "⌚",
    gradient: "from-indigo-800 via-indigo-700 to-blue-700",
    image: U("smartwatch,fitness,wearable,sport", 67),
  ...
  },
  {
    ...
    gradient: "from-sky-800 via-blue-700 to-sky-700",
    image: U("thermos,bottle,water,sport", 68),
  ...
  },
  {
    ...
    price: "₺299 – ₺699", emoji: "⚽",
    gradient: "from-lime-800 via-green-700 to-lime-700",
    image: U("pilates,ball,exercise,fitness", 69),
    category: "sport", occasions: ["birthday", "newyear", "surprise"],
  ...
  },
  {
    ...
    gradient: "from-slate-700 via-slate-600 to-gray-600",
    image: U("sports,bag,gym,duffel", 70),
  ...
  },
  {
    ...
    gradient: "from-orange-800 via-orange-700 to-amber-700",
    image: U("foam,roller,massage,recovery", 71),
  ...
  },
  {
    ...
    price: "₺1.299 – ₺3.999", emoji: "⚡",
    gradient: "from-red-800 via-red-700 to-rose-700",
    image: U("massager,muscle,recovery,sport", 72),
    category: "sport", occasions: ["birthday", "anniversary", "newyear"],
  ...
  },
  {
    ...
    price: "₺199 – ₺499", emoji: "🪢",
    gradient: "from-violet-800 via-purple-700 to-violet-700",
    image: U("jump,rope,exercise,fitness", 73),
    category: "sport", occasions: ["birthday", "surprise", "newyear"],
  ...
  },
  {
    ...
    price: "₺249 – ₺549", emoji: "🧩",
    gradient: "from-purple-800 via-violet-700 to-purple-700",
    image: U("yoga,block,strap,stretching", 74),
    category: "sport", occasions: ["birthday", "newyear", "surprise"],
  ...
  },
  {
    ...
    price: "₺199 – ₺499", emoji: "🧦",
    gradient: "from-emerald-800 via-teal-700 to-emerald-700",
    image: U("sports,socks,athletic,fitness", 75),
  ...
  },
  {
    ...
    price: "₺399 – ₺899", emoji: "🩰",
    gradient: "from-pink-800 via-rose-700 to-pink-700",
    image: U("pilates,ballet,fitness,dancer", 76),
  ...
  },
  {
    ...
    price: "₺599 – ₺1.299", emoji: "🏄‍♀️",
    gradient: "from-amber-800 via-amber-700 to-orange-700",
    image: U("balance,board,fitness,core", 77),
    category: "sport", occasions: ["birthday", "newyear", "surprise"],
  ...
  },
  {
    ...
    gradient: "from-cyan-800 via-sky-700 to-cyan-700",
    image: U("headphones,running,sport,outdoor", 78),
    category: "sport", occasions: ["birthday", "newyear"],
  ...
  },
  {
    ...
    gradient: "from-gray-700 via-gray-600 to-zinc-600",
    image: U("sunglasses,sport,outdoor,athletic", 79),
    category: "sport", occasions: ["birthday", "surprise", "valentines"],
  ...
  },
  {
    ...
    price: "₺599 – ₺1.799", emoji: "👗",
    gradient: "from-fuchsia-800 via-pink-700 to-fuchsia-700",
    image: U("yoga,leggings,sportswear,active", 80),
    category: "sport", occasions: ["birthday", "newyear", "anniversary"],
  ...
  // ── LIFESTYLE (20) ──
  {
    ...
    price: "₺999 – ₺2.499", emoji: "🛁",
    gradient: "from-stone-700 via-stone-600 to-zinc-600",
    image: U("spa,wellness,massage,relax", 81),
  ...
  },
  {
    ...
    gradient: "from-red-800 via-red-700 to-rose-700",
    image: U("language,learning,education,books", 82),
  ...
  },
  {
    ...
    gradient: "from-amber-900 via-amber-800 to-orange-800",
    image: U("candle,aroma,soy,luxury,home", 83),
  ...
  },
  {
    ...
    gradient: "from-rose-900 via-rose-800 to-pink-800",
    image: U("jewelry,necklace,personalized,gift", 84),
  ...
  },
  {
    ...
    price: "₺599 – ₺1.299", emoji: "☕",
    gradient: "from-amber-800 via-amber-700 to-yellow-700",
    image: U("coffee,frenchpress,brewing,beans", 85),
  ...
  },
  {
    ...
    price: "₺399 – ₺899", emoji: "🍵",
    gradient: "from-green-800 via-emerald-700 to-green-700",
    image: U("tea,teapot,collection,herbal", 86),
    category: "lifestyle", occasions: ["birthday", "surprise", "valentines"],
  ...
  },
  {
    ...
    gradient: "from-pink-800 via-rose-700 to-pink-700",
    image: U("photo,collage,memories,wall", 87),
    category: "lifestyle", occasions: ["valentines", "anniversary", "birthday"],
  ...
  },
  {
    ...
    price: "₺299 – ₺699", emoji: "📅",
    gradient: "from-indigo-800 via-indigo-700 to-blue-700",
    image: U("planner,agenda,notebook,calendar", 88),
  ...
  },
  {
    ...
    price: "₺499 – ₺1.299", emoji: "🌙",
    gradient: "from-purple-800 via-violet-700 to-purple-700",
    image: U("silk,pillow,bedding,luxury,sleep", 89),
    category: "lifestyle", occasions: ["birthday", "valentines", "anniversary"],
  ...
  },
  {
    ...
    price: "₺399 – ₺899", emoji: "🌿",
    gradient: "from-teal-800 via-teal-700 to-cyan-700",
    image: U("diffuser,aromatherapy,essential,oils", 90),
    category: "lifestyle", occasions: ["birthday", "surprise", "valentines"],
  ...
  },
  {
    ...
    price: "₺699 – ₺1.799", emoji: "🛀",
    gradient: "from-sky-800 via-blue-700 to-sky-700",
    image: U("bathrobe,hotel,luxury,cotton", 91),
    category: "lifestyle", occasions: ["birthday", "valentines", "anniversary"],
  ...
  },
  {
    ...
    gradient: "from-slate-700 via-slate-600 to-gray-600",
    image: U("restaurant,dining,food,elegant", 92),
    category: "lifestyle", occasions: ["valentines", "anniversary", "birthday"],
  ...
  },
  {
    ...
    price: "₺499 – ₺1.299", emoji: "👨‍🍳",
    gradient: "from-orange-800 via-orange-700 to-amber-700",
    image: U("cooking,kitchen,chef,food", 93),
    category: "lifestyle", occasions: ["birthday", "newyear", "surprise"],
  ...
  },
  {
    ...
    price: "₺399 – ₺799", emoji: "🧘",
    gradient: "from-violet-800 via-purple-700 to-violet-700",
    image: U("meditation,yoga,calm,mindfulness", 94),
    category: "lifestyle", occasions: ["birthday", "newyear", "surprise"],
  ...
  },
  {
    ...
    image: U("wine,cheese,board,luxury", 95),
  ...
  },
  {
    ...
    price: "₺399 – ₺899", emoji: "💝",
    gradient: "from-rose-800 via-rose-700 to-pink-700",
    image: U("jewelry,box,personalized,velvet", 96),
    category: "lifestyle", occasions: ["birthday", "valentines", "anniversary"],
  ...
  },
  {
    ...
    gradient: "from-gray-700 via-gray-600 to-zinc-600",
    image: U("digital,photo,frame,display", 97),
    category: "lifestyle", occasions: ["birthday", "valentines", "anniversary"],
  ...
  },
  {
    ...
    image: U("chocolate,gift,luxury,sweet", 98),
    category: "lifestyle", occasions: ["valentines", "birthday", "surprise", "anniversary"],
  ...
  },
  {
    ...
    gradient: "from-blue-800 via-blue-700 to-indigo-700",
    image: U("motivation,growth,book,success", 99),
  ...
  },
  {
    ...
    gradient: "from-zinc-700 via-zinc-600 to-neutral-600",
    image: U("sunglasses,fashion,polarized,luxury", 100),
